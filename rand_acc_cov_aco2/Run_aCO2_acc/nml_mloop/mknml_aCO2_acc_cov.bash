...
# Added by Bian 18Apr2024, for received mloop parameters from run_CN_2CO2_acc_mloop.sh
formatted_mloop=$(printf "%04d" $1)
...
&cable
   ...
   casafile%cnptrait = '/home/bian_cy/case_unc/0_data/SLA_Na_cov_aCO2/SLA_Na_cov_aCO2_${formatted_mloop}.csv' !file for grid-based SLA and Nleaf (Bian,2Jun2024)
