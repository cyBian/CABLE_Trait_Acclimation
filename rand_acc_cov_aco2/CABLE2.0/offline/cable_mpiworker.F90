...
!  CALL MPI_Bcast (mstype, 1, MPI_INTEGER, 0, comm, ierr)
  ...
  blen(bidx) = mvtype * extr2
  !write(*,*) 'sla:bidx,mvtype,extr2',bidx,mvtype,extr2,mvtype*extr2,ntyp

  ! Added by Bian for grid-based sla (17Apr2024)
  bidx = bidx + 1
  CALL MPI_Get_address (casabiome%sla_grid, displs(bidx), ierr)
  blen(bidx) = r2len
  !write(*,*) 'sla_grid:bidx,r2len,ntyp',bidx,r2len,ntyp
  ! --------------- End Added ----------------------------
...
!===================================================================
  ...
  bidx = bidx + 1
  CALL MPI_Get_address (casapool%nleaf, displs(bidx), ierr)
  blen(bidx) = r2len
  ! ==================== End added ===================================
