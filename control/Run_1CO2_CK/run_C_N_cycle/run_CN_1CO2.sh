...
ROOT=/home/bian_cy/case_unc/control
WORKDIR=$ROOT/Run_1CO2_CK/
...
do
  ...
  do
    ...
    mv out_cable.nc      ${OUTDIR}/out_cable_${i}_${yr}_1CO2_CK_CN_without_ndep.nc
    cp -p restart_out.nc restart_in.nc
    mv restart_out.nc    ${OUTDIR}/restart_out_${i}_${yr}_1CO2_CK_CN_without_ndep.nc
    echo "For year ${yr}"
    yr=`expr $yr + 1`
  done
  i=`expr $i + 1`
