...
MODULE casaparm
  ...
  IMPLICIT NONE
  INTEGER, PARAMETER :: initcasa = 1   ! =0 spin generating a restart file ; 1 restart file
...
MODULE casavariable
  ...
  TYPE casa_biome
    ...
    REAL(r_2), DIMENSION(:),POINTER :: xkleafcoldmax,  &
                                       ...
                                       glaimin,        &
                                       sla,            &
                                       sla_grid,       & ! Add by Bian 17Apr2024
                                       ratiofrootleaf, &
                                       kroot,          &
                                       krootlen,       &
                                       rootdepth,      &
  ...
  TYPE casa_pool
    REAL(r_2), DIMENSION(:),POINTER :: Clabile,       &
                                       dClabiledt
    REAL(r_2), DIMENSION(:),POINTER :: nleaf ! Add by Bian 20Apr2024               
...
! Added filename type for casaCNP (BP apr2010)
  TYPE casafiles_type
    ...
    CHARACTER(LEN=99) :: ndep          ! N deposition input file (Chris LU and XZhang,02Dec2014)
! added yp wang
    ...
    LOGICAL           :: l_ndep      !added by Chris LU and XZhang,02Dec2014

    CHARACTER(LEN=99) :: cnptrait  ! file for grid-based SLA and Nleaf (Bian,16Apr2024)
...
!  mvt = mvtype
  ALLOCATE(casabiome%ivt2(mvtype),                   &
           ...
           casabiome%sla_grid(arraysize),            & ! added by Bian 17Apr2024
  ...
  ALLOCATE(casapool%Clabile(arraysize),               &
           ...
           casapool%nleaf(arraysize),                 & !add by Bian 20Apr2024
