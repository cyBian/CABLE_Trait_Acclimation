...
!  INTEGER, PARAMETER :: ncasaparam = 196     ! changed ypw to add 13 new variables in casabiome%
   ...
   ! add one new variables in casabiome% and one new variable in casapool (casapool%nleaf)
   INTEGER, PARAMETER :: ncasaparam = 198 ! chenged Bian 18Apr2024 to add 1 new variables in casabiome%
...
!  INTEGER, PARAMETER :: ncasa_mat = 32    ! changed  ypw 27-bov-2012 17 new variables added for casa spinup
  INTEGER, PARAMETER :: ncasa_mat = 33    ! changed x.zhang 10/01/2015 add casaflux%Crmplant to casa_poolout
...
! INTEGER, PARAMETER :: ncasa_vec = 32 !changed on 30-jan-2013 for adding four new respiration variable to the output
  INTEGER, PARAMETER :: ncasa_vec = 39 ! add seven casaflux variables by x.zhang 10/01/2015 to casa_poolout
