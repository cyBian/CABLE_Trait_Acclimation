...
ROOT=/home/bian_cy/case_unc/rand_acc_cov
...
do
  ...
  ./mknml_2CO2_acc_cov.bash ${i}
  cd ${original_dir}
  ln -sf ../nml_mloop nml

  # generate the outdir for each loop
  OUTDIR_loop=${OUTDIR}/out_2CO2_acc_cov_$i
  mkdir -p ${OUTDIR_loop}
  ...
  do
    ...
    mv out_cable.nc      ${OUTDIR_loop}/out_cable_${i}_${yr}_2xCO2_acc_cov.nc
    cp -p restart_out.nc restart_in.nc
    mv restart_out.nc    ${OUTDIR_loop}/restart_out_${i}_${yr}_2xCO2_acc_cov.nc
