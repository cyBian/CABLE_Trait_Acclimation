...
seq ${iloop} ${mloop} | parallel -j8 "
   cd ${DaPath}/out_2CO2_acc_cov_{}/
   
   ncrcat -O out_cable_* out_cable_{}_1981-2013_2xCO2_acc_cov.nc
   
   ncks -O -v GPP,NPP,LAI,NEE,RadT,Rainf,Tair,latitude,longitude out_cable_{}_1981-2013_2xCO2_acc_cov.nc \
   ${DaPath}/out_proc/out_cable_{}_1981-2013_2xCO2_acc_cov_tarVars.nc
